...
#define kXandYSpaceForSuperView 27.0
...
-(instancetype)initWithFrame:(CGRect)frame andLineChartType:(JHLineChartType)lineChartType{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        _pointNumberColorArr = @[[UIColor whiteColor]];
            ...
            if (_valueArr.count) {
                ...
                if (max<=2) {
                    for (NSInteger i = 0; i<3; i++) {
                        ...
                        [arr addObject:[NSString stringWithFormat:@"%.2f",(i+1)*0.5]];
                ...
                //max大于100时取50的整数倍
                     ...
                     max = (max/20 + 1)*20;
                    for (NSInteger i = 0; i < max/20; i++) {
                        
                        [arr addObject:[NSString stringWithFormat:@"%ld",(i+1)*20]];
                       
                    }
                    
                }else if (max>200&&max<=500){
                    max = (max/50 + 1)*50;
                    for (NSInteger i = 0; i < max/50; i++) {
                        
                        [arr addObject:[NSString stringWithFormat:@"%ld",(i+1)*50]];
                    ...
                    max = (max/500 + 1)*500;
                    for (NSInteger i = 0; i < max/500; i++) {
                        
                        [arr addObject:[NSString stringWithFormat:@"%ld",(i+1)*500]];
