...
#define k_COLOR_STOCK  @[[UIColor colorWithRed:0.239 green:0.651 blue:0.170 alpha:1.000],[UIColor colorWithRed:1.000 green:0.562 blue:0.968 alpha:1.000],[UIColor colorWithRed:1.000 green:0.783 blue:0.371 alpha:1.000], [UIColor colorWithRed:0.313 green:1.000 blue:0.983 alpha:1.000],[UIColor colorWithRed:0.560 green:1.000 blue:0.276 alpha:1.000]]
...
-(void)drawRect:(CGRect)rect{
    ...
    CGFloat lastBegin = 0;
    CGFloat longLen = _redius +50*k_Width_Scale;
    for (NSInteger i = 0; i<_valueDataArr.count; i++) {
        ...
        CGPoint endx = CGPointMake(self.chartOrigin.x + sin(midSpace) * longLen, self.chartOrigin.y-2 - cos(midSpace)*longLen);
        ...
        CGSize size = [[NSString stringWithFormat:@"%ld",[obj integerValue] ] boundingRectWithSize:CGSizeMake(200, 100) options:NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:10*k_Width_Scale]} context:nil].size;
        
        if (midSpace<M_PI) {
            secondP =CGPointMake(endx.x + 35*k_Width_Scale, endx.y);
          [self drawText:[NSString stringWithFormat:@"%ld",[obj integerValue]] andContext:contex atPoint:CGPointMake(secondP.x -5, secondP.y - size.height / 2) WithColor:k_COLOR_STOCK[i] andFontSize:35*k_Width_Scale];

        }else{
             secondP =CGPointMake(endx.x - 35*k_Width_Scale, endx.y);
            [self drawText:[NSString stringWithFormat:@"%ld",[obj integerValue]] andContext:contex atPoint:CGPointMake(secondP.x - size.width - 3, secondP.y - size.height/2) WithColor:k_COLOR_STOCK[i] andFontSize:30*k_Width_Scale];
        }
